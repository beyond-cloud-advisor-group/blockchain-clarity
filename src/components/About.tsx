        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-sm text-muted-foreground uppercase tracking-[0.15em] font-medium">About</span>
            </div>
          </AnimatedSection>
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-4xl md:text-5xl font-display font-bold mb-2 gradient-text">{stat.value}</div>
